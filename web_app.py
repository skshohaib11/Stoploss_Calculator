...
st.sidebar.write("This calculator is mainly focused on setting stoploss by knowing in advance the rough estimate of amount that can be lost in that particular trade and to be prepared for the same.")
...
target_points = col2.number_input("Target Points :", min_value=5, max_value=100, step=5, format="%d")
